...
def seed_appointments():
    ...
    appointment4 = Appointment(agent_id=7, user_id=1, property_id=4, date="2022-6-11", time="12:30", message="I am interested to tour this house")
    ...
    appointment7 = Appointment(agent_id=10, user_id=1, property_id=7, date="2022-6-11", time="13:00", message="I am interested to tour this house")
    ...
    appointment10 = Appointment(agent_id=13, user_id=1, property_id=10, date="2022-6-11", time="13:30", message="I am interested to tour this house")
    ...
    appointment12 = Appointment(agent_id=15, user_id=3, property_id=12, date="2022-6-11", time="13:30", message="I am interested to tour this house")
    ...
    appointment14 = Appointment(agent_id=17, user_id=2, property_id=14, date="2022-6-11", time="14:00", message="I am interested to tour this house")
